...
*/
    ...
    _sample.input_temperature = LOWPASS(_sample.input_temperature, adcValues[0], 4);
    _sample.phase_values[0] = LOWPASS(_sample.phase_values[0], adcValues[1], 4);
    _sample.input_voltage = LOWPASS(_sample.input_voltage, adcValues[2], 4);
    _sample.phase_values[1] = LOWPASS(_sample.phase_values[1], adcValues[3], 4);
    _sample.phase_values[2] = LOWPASS(_sample.phase_values[2], adcValues[4], 4);
